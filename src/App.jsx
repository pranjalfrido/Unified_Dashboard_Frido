        ...
        return (
          <>
            ...
            {(() => {
              ...
              const totalRowS = { fontSize: 9.1, fontWeight: 700, color: C.t1, padding: '11px 16px', textAlign: 'right', whiteSpace: 'nowrap', background: C.bg, borderTop: `2px solid ${C.border}` }
