...
function ChannelTrendCard({ dailyArr, channels }) {
  ...
  const axisProps = {
    ...
    tooltip: <Tooltip content={<ChartTooltip formatter={metric === 'units' ? fmtN : undefined} />} cursor={({ points }) => { if (!points?.length) return null; const x = points[0].x; return <line x1={x} y1={0} x2={x} y2={9999} stroke="#BBBBBB" strokeWidth={1} /> }} />,
