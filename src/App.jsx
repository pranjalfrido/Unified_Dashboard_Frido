        ...
        return (
          <>
            ...
            {(() => {
              ...
              const BOX_H = 320
              const thS = { fontSize: 7.6, fontWeight: 700, color: C.t3, textTransform: 'uppercase', letterSpacing: '.05em', padding: '8px 10px', borderBottom: `1.5px solid ${C.border}`, whiteSpace: 'nowrap', textAlign: 'right', background: C.card }
