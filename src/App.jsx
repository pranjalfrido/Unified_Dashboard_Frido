...
function ShopifyTab({ data, filters, setFilters }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      {isIntl
        ? <Card title="Category Revenue Matrix · Shopify International"><div style={{ fontSize: 12, color: C.t3, padding: '10px 0', textAlign: 'center' }}>Category breakdown not available — International orders data source does not include product category information</div></Card>
        : (() => {
