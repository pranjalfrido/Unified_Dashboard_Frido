...
function OverviewPage({ data, alerts, logisticsData }) {
  const { totalRev, totalExcRev, nOrders, totalQty, totalAspQty = totalQty, blendedAOV, nDays, chMap, catMap, subCatMap, stateMap, nCusts, repeatCusts, dailyArr, prevRev, prevOrders, orderStatusRevMap = {}, rtoRevDirect, returnRev, cirRev, exchangeRev, netRevenueCalc = 0 } = data
