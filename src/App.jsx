        ...
        {isD2C && (() => {
          ...
          return (
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: 10 }}>
              ...
              {card('Meta ROAS', `${metaRoas.toFixed(2)}x`, `${fmt(metaRev)} / ${fmt(metaSpend)}`, null, '#1877F2')}
              ...
              {card('Google ROAS', `${googleRoas.toFixed(2)}x`, `${fmt(googleRev)} / ${fmt(googleSpend)}`, null, '#34A853')}
            </div>
          )
        })()}
