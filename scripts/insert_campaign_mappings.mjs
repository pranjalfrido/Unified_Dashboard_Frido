...
const rows = [
  ...
  {campaign_name:"SP/ArmMonitor/Generic/Phrase/HS/Jun26/C4",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  ...
  {campaign_name:"SP/ArmMonitor/CAT/Jun26/C2",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  ...
  {campaign_name:"SP/ArmMonitor/Auto/Jun26/C2",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  ...
  {campaign_name:"SD/ArmMonitor/CAT/VCPM/Jun26/1",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  ...
  {campaign_name:"SD/ArmMonitor/VR/AP/VCPM/Jun26/1",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  ...
  {campaign_name:"SP/ArmMonitor/Generic/Exact/HS/Jun26/C3",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  ...
  {campaign_name:"SP/ArmMonitor/Brand/Phrase/Jun26/C6",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  {campaign_name:"SD/ArmMonitor/Comp/VCPM/Jun26/1",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  ...
  {campaign_name:"SBV/ArmMonitor/CAT/Jun26/1",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  ...
  {campaign_name:"SBV/ArmMonitor/Phrase/Jun26/1",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  ...
  {campaign_name:"SBV/ArmMonitor/Exact/Jun26/1",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
  ...
  {campaign_name:"SP/ArmMonitor/Brand/Exact/Jun26/C5",platform:"Amazon",product_name:"ErgoLuxe Monitor Arm",category:"Ergo Furniture",target_type:"product"},
...
const header = 'campaign_name,platform,product_name,category,target_type';
const csvLines = rows.map(r =>
  [r.campaign_name, r.platform, r.product_name, r.category, r.target_type]
    .map(v => `"${String(v).replace(/"/g,'""')}"`)
    .join(',')
);
writeFileSync('c:/Users/PranjalTripati/Desktop/campaign_mappings_review.csv', [header, ...csvLines].join('\n'), 'utf8');
console.log('CSV written to Desktop: campaign_mappings_review.csv');
