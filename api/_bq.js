...
price_blinkit AS (SELECT DISTINCT TRIM(productid) AS productid, CAST(Selling_Price AS FLOAT64) AS selling_price FROM \`frido-429506.sharepoint_to_gcp.Frido_Item_Master__productid_sku_mapping\` WHERE TRIM(channelname) = 'Blinkit'),
price_zepto AS (SELECT DISTINCT TRIM(productid) AS productid, CAST(Selling_Price AS FLOAT64) AS selling_price FROM \`frido-429506.sharepoint_to_gcp.Frido_Item_Master__productid_sku_mapping\` WHERE TRIM(channelname) = 'Zepto'),
price_instamart AS (SELECT DISTINCT TRIM(productid) AS productid, CAST(Selling_Price AS FLOAT64) AS selling_price FROM \`frido-429506.sharepoint_to_gcp.Frido_Item_Master__productid_sku_mapping\` WHERE TRIM(channelname) = 'Instamart'),
