...
pincode_master AS (SELECT DISTINCT CAST(Pincode AS STRING) AS pincode, City_L1, City_L3, State, Region, City_Tier, Tier_Label, Is_Metro_City FROM \`frido-429506.production.pincode_city_master\`),
city_name_master AS (SELECT DISTINCT City_L1, City_L3, State, Region, City_Tier, Tier_Label, Is_Metro_City FROM \`frido-429506.production.pincode_city_master\`),
...
SELECT u.Country, u.OrderId, u.Channel, u.SubChannel, u.ChannelAccount, u.OrderDate,
  ...
  COALESCE(pm.City_L3, cm.City_L3) AS City_L3,
  u.Pincode,
