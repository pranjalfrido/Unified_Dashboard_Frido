...
export default async function handler(req, res) {
  ...
  const queries = {
    ...
    prevBl: `WITH q AS (${prevBase}) SELECT SUM(SellingPrice_Inc_GST) AS rev, SUM(SellingPrice_Exc_GST) AS exc_rev, SUM(ItemQty) AS units, COUNT(DISTINCT SKU) AS skus, COUNT(DISTINCT CityName) AS cities FROM q WHERE Channel='Blinkit'`,
