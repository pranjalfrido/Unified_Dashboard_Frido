...
export default async function handler(req, res) {
  ...
  const { start, end, category, subCategory, state, sku, subChannel, voucher } = req.body
  ...
  const base = buildQuery(start, end, { category, subCategory, state, sku, subChannel, voucher })
